...
| Assess | [Assessment and adaptation](references/assessment-and-adaptation.md) for submitted answers, grading, misconceptions, or remediation. | Attempt persisted, mastery transaction applied, later retrieval dates inspected, feedback given, and assessed lesson manifest accepted when applicable. |
